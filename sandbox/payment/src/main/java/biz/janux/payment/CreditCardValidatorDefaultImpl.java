...
public class CreditCardValidatorDefaultImpl implements CreditCardValidator
{
	...
	static
	{
		...
		DEFAULT_CARD_TYPE_PATTERNS.put("JC", "(2131|1800)\\d{11}|3\\d{15}"); // JC - starts with 2131 or 1800 followed by 11 digits or starts with 3 followed by 15 digits
	}
	...
	public boolean isValidTrack2(String track2, String number) {
		...
		String numberFromTrack2=null;
		if (stringTokenizer.hasMoreTokens())
		{
			numberFromTrack2 = stringTokenizer.nextToken();
		}
		return (numberFromTrack2!=null && number!=null && numberFromTrack2.equals(number));
	}
