This folder contains various maven2 pom.xml files with build meta information.  Most of these poms
have a packaging of type 'pom' and as such do not produce any deployable artifacts.  They include the
following:
...
Aggregates assets that are shared among projects, such as spring configuration files, hibernate
mappings, sql creation scripts, test data, etc... and generates a zip file from which assets can
then be imported into other projects.
