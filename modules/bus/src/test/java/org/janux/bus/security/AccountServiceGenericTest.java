...
public class AccountServiceGenericTest extends TransactionalBusTestAbstractGeneric
{
	...
	private String testPasswordEncrypted = "mG8IpXEBpgOvLlOyBnnDoyNPYcA=";
	...
	*/
	...
	{
		Account account = accountServiceGeneric.findAccountByName(ACCOUNT_HERA);
		accountServiceGeneric.setAccountPassword(account, testPassword);
		
		accountServiceGeneric.saveOrUpdateAccount(account);
				
		AccountImpl accountHera = (AccountImpl)accountServiceGeneric.findAccountByName(ACCOUNT_HERA);
	...
	public static void main(String[] args)
	{
			...
			tSuite.addTest(new AccountServiceGenericTest("testPasswordEncryption"));
