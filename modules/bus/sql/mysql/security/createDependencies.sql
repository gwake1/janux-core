...
alter table sec_permission_bit 
	add constraint fk_PermissionBit__PermissionContext foreign key (contextId) references sec_authorization_context (id);

alter table sec_permission_granted 
	add constraint fk_PermissionGranted__PermissionContext foreign key (contextId) references sec_authorization_context (id);
